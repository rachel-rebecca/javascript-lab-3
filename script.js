...
// What I originally wrote for find lowest score function
...
function findLowestScore (array) {
    ...
    let lowestScoreObj = array.find(element => element.score === lowestScore);
    console.log("The lowest score is: " + JSON.stringify(lowestScoreObj));
}
// call lowest score 
